...
class NoteDatabaseHelp(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    override fun onCreate(db: SQLiteDatabase?) {
        val createTableQuery = "CREATE TABLE $TABLE_NAME ($COLUMN_ID INTEGER PRIMARY KEY, $COLUMN_TITLE TEXT, $COLUMN_CONTENT TEXT, $COLUMN_DATE TEXT, $COLUMN_PRIORITY INTEGER)"
    ...
    fun insertNote(note: Note) {
        ...
        val values = ContentValues().apply {
            ...
            put(COLUMN_DATE, SimpleDateFormat("yyyy-MM-dd", Locale.getDefault()).format(note.date))
